 ...
 *
 * Note what this deliberately does *not* do: recompute a weighted mean. When
 * one account is selected there is nothing to weight — the API already returns
 * that account's own cost price in the breakdown — so the trap #655 called the
