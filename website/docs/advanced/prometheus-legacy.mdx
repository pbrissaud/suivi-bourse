...
| `sb_price_staleness` | `1` when the stored price is **silently stale** — frozen across consecutive open-market cycles while the live quote moves — `0` otherwise. See the [price-freshness sonde](/docs/advanced/market-aware-scraping#price-freshness-sonde). |
