...
Six tools, and your agent picks between them on its own:
...
| `get_investment_rhythm` | how much you buy in a month and how often — measured on your purchases over the last twelve months |
...
creates an account or turns a dial. Every one of the six reads. If an agent tells
...
serves changes, **the six names above and the shape of what they return are held
