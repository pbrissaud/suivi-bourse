...
[deployment section](/docs/v4/category/deployment).
...
See [Manual mode](/docs/v4/configuration/manual-mode) for the full reference.
...
See [Events mode](/docs/v4/configuration/events-mode) for the full CSV format.
Events mode also unlocks [historical backfill](/docs/v4/backfill).
...
[Historical backfill](/docs/v4/backfill) to understand and tune this behaviour.
:::
