...
[Upgrading to accounts](/docs/v4/advanced/upgrading-accounts) for how the data model
is laid out.
:::
...
Since [market-aware scraping](/docs/v4/advanced/market-aware-scraping), SuiviBourse
...
[market-aware scraping](/docs/v4/advanced/market-aware-scraping#weekend-and-holiday-gaps)
note on widening them past a weekend.

## Numbers that settle over time

Right after startup, [backfill](/docs/v4/backfill) is still walking price history
