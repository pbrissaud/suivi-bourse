...
[Upgrading to accounts](/docs/v4/advanced/upgrading-accounts) for the full picture.
:::
...
For opt-in [accounts](/docs/v4/configuration/events-mode#accounts-opt-in),
...
In the [Docker Compose](/docs/v4/deployment/docker-compose) stack, the database is
...
[token note in the Docker Compose guide](/docs/v4/deployment/docker-compose#environment-variables).
:::
