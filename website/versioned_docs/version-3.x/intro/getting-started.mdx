...
To see all the documentation about running the app, visit [deployment section](/docs/v3/category/deployment)
...
## 2. Modify config
Edit the `config.yaml` file located in `docker-compose` folder. Complete the file with the provided example or visit the [chapter 3](/docs/v3/intro/config) of the documentation to know more about writing config file. 
