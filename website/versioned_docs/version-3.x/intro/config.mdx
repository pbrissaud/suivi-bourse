...
:::caution
The config file has to be named **config.yaml**. To see where it should be located on your filesystem, read the [deployment section](/docs/v3/category/deployment)
:::
