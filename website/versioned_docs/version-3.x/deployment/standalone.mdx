...
Standalone mode only deploys the **Python script**. You should install and configure Prometheus and Grafana (or another tools if you want) by yourself to have the stack described in the [Design](/docs/v3/intro/design) section. 
...
3. Write a `config.yaml` (name can't be changed) following this [doc](/docs/v3/intro/config) in **one of the following paths** : 
...
- [Version 11.x](https://github.com/pbrissaud/suivi-bourse/blob/master/assets/grafana-dashboard-external-v11.json)
- [Version 10.x](https://github.com/pbrissaud/suivi-bourse/blob/master/assets/grafana-dashboard-external-v10.json)
- [Version 9.x](https://github.com/pbrissaud/suivi-bourse/blob/master/assets/grafana-dashboard-external-v9.json)
- [Version 8.x](https://github.com/pbrissaud/suivi-bourse/blob/master/assets/grafana-dashboard-external-v8.json)
