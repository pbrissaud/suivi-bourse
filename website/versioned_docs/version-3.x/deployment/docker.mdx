...
Docker mode only deploys the **SuiviBourse container**. You should install and configure Prometheus and Grafana (or another tools if you want) by yourself to have the stack described in the [Design](/docs/v3/intro/design) section. 
...
1. Write a `config.yaml` (name can't be changed) following this [page](/docs/v3/intro/config) wherever you want
