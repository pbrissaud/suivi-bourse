 ...
 * to `+1 686,53 €`, and nothing on screen says which one equals the
 * dashboard's. So the closed positions never leave the table: they **fold**,
 * the fold is not a filter, and this figure does not move when the section
 * opens.
 *
 *     Σ latent + Σ realised + Σ dividends  ==  gain_absolu
 *             (closed positions included)
 *
 * The dashboard's head does; that is why the two figures can differ and why the
 * reader has to be told which is which.
 *
 * The folded section is not a surface but a part of the page, which is what
 * takes eleven icons down to nine (#684 D7).
 */
